  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f8fa' }}>
      ...
      <div className="container" style={{ padding: 'clamp(24px,4vw,40px) 24px' }}>
        ...
        {error && (
          <div style={{
            background: 'rgba(200,16,46,0.05)', border: '1px solid rgba(200,16,46,0.2)',
            borderLeft: '4px solid #C8102E', borderRadius: '6px',
            padding: '14px 18px', marginBottom: '24px', color: '#C8102E', fontSize: '14px',
          }}>
            Le backend n&apos;est pas connecté. La formation ci-dessous est disponible.
          </div>
        )}
