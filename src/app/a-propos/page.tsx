  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7f8fa' }}>
      ...
      <div className="container" style={{ padding: 'clamp(48px,6vw,80px) 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(40px,6vw,80px)', alignItems: 'start', marginBottom: '64px' }} className="about-grid">

          {/* Image */}
          <div style={{ borderRadius: '8px', overflow: 'hidden', boxShadow: '0 8px 40px rgba(0,0,0,0.12)' }}>
            <img
